...
public class MainTest {
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(searchUp(moves,0,3000));

        System.out.println(searchTurnAndStandStill(moves,0,3000));

        //System.out.println(standStill(moves,0,498));

        System.out.println(searchCDG(moves,0,3000));
        //System.out.println(listCDG(moves,0,3000));
